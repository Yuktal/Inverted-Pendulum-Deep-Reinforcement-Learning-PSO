...
class CartPoleEnv(gym.Env):
    ...
    def _step(self, action):
        ...
        thetaacc = (self.gravity * sintheta - (costheta * (temp-sig)) - (self.mup * theta_dot / self.polemass_length)) / (self.length * (4.0/3.0 - self.masspole * costheta * costheta / self.total_mass))
        xacc  = (temp - (self.polemass_length * thetaacc * costheta)-sig) / self.total_mass
        x  = x + self.tau * x_dot
